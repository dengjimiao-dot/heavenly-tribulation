...
final class GameLogic {
  ...
  static Future<void> heroTasteJiejiPotion(dynamic location) =>
      _heroTasteJiejiPotion(location);

  static Future<void> heroScribeJiejiTalisman(dynamic location) =>
      _heroScribeJiejiTalisman(location);

  static Future<void> heroPasteJiejiTalisman(dynamic location) =>
      _heroPasteJiejiTalisman(location);

  static Future<void> heroDrillJiejiArena(dynamic location) =>
      _heroDrillJiejiArena(location);

  static Future<void> heroVisitJiejiTomb(dynamic location) =>
      _heroVisitJiejiTomb(location);
  ...
  static Future<void> heroReadJiejiNight(dynamic location) =>
      _heroReadJiejiNight(location);

  static Future<void> heroRestJiejiSite(dynamic location) =>
      _heroRestJiejiSite(location);

  static Future<void> heroStudyJiejiHome(dynamic location) =>
      _heroStudyJiejiHome(location);

  static Future<void> heroFeastJiejiHotel(dynamic location) =>
      _heroFeastJiejiHotel(location);

  static Future<void> heroConsultJiejiStars(dynamic location) =>
      _heroConsultJiejiStars(location);
  ...
  static Future<void> heroInkJiejiTattoo(dynamic location) =>
      _heroInkJiejiTattoo(location);

  static Future<void> heroCraftJiejiWeapon(dynamic location) =>
      _heroCraftJiejiWeapon(location);

  static void onInteractWorkbench({dynamic location}) =>
      _onInteractWorkbench(location: location);
